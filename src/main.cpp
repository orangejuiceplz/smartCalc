...
class MyPanel: public wxPanel {
  public: MyPanel(wxWindow * parent): wxPanel(parent) {}
...
class MainFrame: public wxFrame {
  ...
  private: void OnExit(wxCommandEvent & event);
...
void MainFrame::OnGraph(wxCommandEvent & event) {
  wxString
  function = wxGetTextFromUser("Enter the function to graph (e.g., sin(x)):", "Graph Function");
  if (! function.IsEmpty()) {
